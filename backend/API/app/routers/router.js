 ...
 * @param {email,password} FormData - required
 * @returns {Admin connect} 200 - Admin connected
 * @returns {Error} 500 - Server error
 */
 ...
 * @returns {reports} 200 - Show all reports 
 * @returns {Error} 500 - Server error
 */
 ...
 * @returns {reports} 200 - Show all messages 
 * @returns {Error} 500 - Server error
 */
    .get(adminController.getAllMessage);
router.route('/admin/reports/:reviewId')
/**
 * Delete an unsuitable review
 * @route DELETE /admin/reports/{reviewId}
 * @returns {Review deleted} 200 - Delete an unsuitable review
 * @returns {Error} 500 - Server error
 */
    .delete(adminController.deleteReview)
/**
 * Clean an unsuitable report for one review
 * @route PATCH /admin/reports/{reviewId}
 * @returns {Review is clean} 200 - Clean an unsuitable report for one review
 * @returns {Error} 500 - Server error
 */
